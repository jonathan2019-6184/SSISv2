...
class Home(ssis.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        leftcolor = ssis.Label(self,height = 60,width=600, bg="skyblue")
        leftcolor.place(x=0,y=0)
        label = ssis.Label(self, text = "SIMPLE STUDENT INFORMATION SYSTEM",bd=4,relief=RIDGE, font=("Bodoni MT",40,"bold"),bg="skyblue", fg="Gray10")
...
#________WINDOW BUTTONS________#
        ...
        Button2 = ssis.Button(self, text="HOME",font=("Palatino roman",25,"bold"),bd=10,width = 10,bg="#cdc9c9",fg="BLACK",command=lambda: controller.ShowFrame(Home))
        Button2.place(x=525,y=500)
        Button3 =ssis.Button(self, text="STUDENTS",font=("Palatino roman",25,"bold"),bd=10, width = 10,bg="#cdc9c9",fg="BLACK",command=lambda: controller.ShowFrame(Student))
...
class Course(ssis.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        leftcolor = ssis.Label(self,height = 60,width=600, bg="skyblue")
        leftcolor.place(x=0,y=0)
        label = ssis.Label(self, text = "C O U R S E",bd=4, font=("Times new roman",40,"bold"),bg="skyblue", fg="Black")
